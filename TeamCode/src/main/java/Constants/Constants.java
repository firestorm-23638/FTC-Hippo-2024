...
public class Constants {
    ...
    public static final double ELEVATOR_HIGH_BASKET_POS  = 1500;//2700;
    public static final double ELEVATOR_OVERFLOW_POS  = 1500;//2700;
    ...
    public static final Depositor.AnglePair DEPOSITOR_PIVOT_TO_VERTICAL_TRANSITION_ANGLE_PAIR = new Depositor.AnglePair(86, 115); //109,130
    public static final Depositor.AnglePair DEPOSITOR_PIVOT_TO_SPECIMEN_PICKUP_ANGLE_PAIR = new Depositor.AnglePair(135, 70); //109,130
    public static final Depositor.AnglePair DEPOSITOR_PIVOT_TO_SPECIMEN_PRIME_ANGLE_PAIR  = new Depositor.AnglePair(137, 50); //109,130

    public static final Depositor.AnglePair DEPOSITOR_PIVOT_TO_PRIME_PAIR = new Depositor.AnglePair(69, 121);
    public static final Depositor.AnglePair DEPOSITOR_PIVOT_TO_HOME_ANGLE_PAIR = new Depositor.AnglePair(155, 90);
    public static final Depositor.AnglePair DEPOSITOR_PIVOT_TO_BASKET_ANGLE_PAIR   = new Depositor.AnglePair(34, 73);
    public static final Depositor.AnglePair DEPOSITOR_PIVOT_TO_SPECIMEN_SCORE_ANGLE_PAIR = new Depositor.AnglePair(81, 40);
    ...
    public static final double EXTENSION_OUT_ANGLE      = 27;
    public static final double EXTENSION_IN_ANGLE       = 10;
    ...
    public static final double INTAKE_PIVOT_TO_TRANSITION_ANGLE = 163.5;
