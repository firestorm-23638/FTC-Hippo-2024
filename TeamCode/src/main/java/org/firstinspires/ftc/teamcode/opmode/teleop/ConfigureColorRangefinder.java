...
//        crf.setPin1Digital(ColorRangefinder.DigitalMode.HSV, 0, 20); // placeholder
        ...
        // RED HSV: 60, 30.8, 3.3
        // BLUE HSV: 198, 57.3, 3.8

        crf.setPin0Digital(ColorRangefinder.DigitalMode.HSV, 140 / 360.0 * 255, 250 / 360.0 * 255); // blue
        crf.setPin0Digital(ColorRangefinder.DigitalMode.HSV, 75 / 360.0 * 255, 115 / 360.0 * 255); // yellow
        crf.setPin0DigitalMaxDistance(ColorRangefinder.DigitalMode.HSV, 30); // 20mm or closer requirement
//
        crf.setPin1Digital(ColorRangefinder.DigitalMode.HSV, 0 / 360.0 * 255, 74 / 360.0 * 255); // red
        crf.setPin1Digital(ColorRangefinder.DigitalMode.HSV, 75 / 360.0 * 255, 100 / 360.0 * 255); // yellow
