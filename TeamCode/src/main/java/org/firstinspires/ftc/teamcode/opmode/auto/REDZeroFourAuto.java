...
@Autonomous
public class REDZeroFourAuto extends CommandOpMode {
    ...
    public void initialize() {
        ...
        Pose2d home = new Pose2d(38,60.5, Math.toRadians(180 + 90));
        ...
        Action basketToFirstSample = drive.getTrajectoryBuilder(new Pose2d(basketPos, Math.toRadians(180 + 45)))
                .strafeToLinearHeading(new Vector2d(48, 52), Math.toRadians(180 + 90))
                .build();

        Action basketToSecondSample = drive.getTrajectoryBuilder(new Pose2d(basketPos, Math.toRadians(180 + 45)))
                .splineToLinearHeading(new Pose2d(56, 53, Math.toRadians(180 + 90)), Math.toRadians(180 + 90))
                .build();
        ...
        Action basketToFourthSample = drive.getTrajectoryBuilder(new Pose2d(basketPos, Math.toRadians(180 + 45)))
                ...
                .splineTo(new Vector2d(-30, 35), Math.toRadians(180 + 30))
                .build();
