...
@Autonomous
public class RED4Specimen0Sample extends CommandOpMode {
    ...
    public void initialize() {
        ...
        Action startToSpecimen = RedActions.startToSpecimen(drive, home, RedActions.rightSpecimenPos);
        Action toFirstSample = RedActions.toFirstSample(drive);
        Action pushFirstSample = RedActions.pushFirstSample(drive);

        Action toSecondSample = RedActions.toSecondSample(drive);
        Action pushSecondSample = RedActions.pushSecondSample(drive);
        Action placeSecondSpecimen = RedActions.placeSecondSpecimen(drive);

        Action pickupThirdSpecimen = RedActions.pickupThirdSpecimen(drive);
        Action placeThirdSpecimen = RedActions.placeThirdSpecimen(drive);

        Action pickupFourthSpecimen = RedActions.pickupFourthSpecimen(drive);
        Action placeFourthSpecimen = RedActions.placeFourthSpecimen(drive);
