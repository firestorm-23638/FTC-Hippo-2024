...
public class FConstants { // This is how we change Follower Constants.
    static {
        ...
        FollowerConstants.mass = 10.88; // In kg
        ...
        FollowerConstants.xMovement = 78.96089314417337;
        FollowerConstants.yMovement = 68.9393;
        FollowerConstants.forwardZeroPowerAcceleration = -28.9758;
        FollowerConstants.lateralZeroPowerAcceleration = -61.8062;

        FollowerConstants.translationalPIDFCoefficients.setCoefficients(0.1,0,0.01,0);   // tuned
