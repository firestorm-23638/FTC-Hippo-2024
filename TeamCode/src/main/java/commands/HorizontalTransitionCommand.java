...
*/
public class HorizontalTransitionCommand extends SequentialCommandGroup {
    private final Depositor depositor;
    private final Intake intake;
    private final Elevator elevator;

    public HorizontalTransitionCommand(Depositor depositor, Intake intake, Elevator elevator) {
        ...
        this.addCommands(
                new SequentialCommandGroup(
                        new ParallelCommandGroup(
                                ...
                                new IntakePositionCommand(intake, Intake.state.VERTICAL_TRANSITION).withTimeout(500)
                        ),
                        new ParallelCommandGroup(
                                new SequentialCommandGroup(
