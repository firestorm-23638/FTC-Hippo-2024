...
public class Actions {
    ...
    public static final Pose rightmostSamplePose = new Pose(
            21.8,
            121.5,
            Math.toRadians(0)
    );
    public static final Pose middleSamplePose = new Pose(
            15,
            129,
            Math.toRadians(0)
    );
    public static final Pose leftmostSamplePose = new Pose(
            27.6,
            131.35,
            Math.toRadians(30)
    );
...
//    public static final Pose pickupSpecimenPos = new Pose(45, -66, Math.toRadians(0));
    ...
    public static PathChain startToBasket(Pose home) {
        PathBuilder builder = new PathBuilder();

        return builder
                .addPath(new BezierCurve(
                        new Point(home),
                        new Point(19.978, 112.702),
                        new Point(basketPos)
                ))
    ...
    public static PathChain basketToFirstSample() {
        PathBuilder builder = new PathBuilder();

        return builder
                .addPath(new BezierLine(
                        new Point(basketPos),
                        new Point(rightmostSamplePose)
                ))
                .setLinearHeadingInterpolation(basketPos.getHeading(), rightmostSamplePose.getHeading())
                .build();
    }

    public static PathChain basketToSecondSample() {
        PathBuilder builder = new PathBuilder();

        return builder
                .addPath(new BezierLine(
                        new Point(basketPos),
                        new Point(middleSamplePose)
                ))
                .setLinearHeadingInterpolation(basketPos.getHeading(), middleSamplePose.getHeading())
                .build();
    }

    public static PathChain basketToThirdSample() {
        PathBuilder builder = new PathBuilder();

        return builder
                .addPath(new BezierLine(
                        new Point(basketPos),
                        new Point(leftmostSamplePose)
                ))
    ...
    public static PathChain firstSampleToBasket() {
        PathBuilder builder = new PathBuilder();
        ...
        return builder
                ...
                .setLinearHeadingInterpolation(rightmostSamplePose.getHeading(), basketPos.getHeading())
                .build();
    }

    public static PathChain secondSampleToBasket() {
        PathBuilder builder = new PathBuilder();
        ...
        return builder
                ...
                .setLinearHeadingInterpolation(middleSamplePose.getHeading(), basketPos.getHeading())
                .build();
    }

    public static PathChain thirdSampleToBasket() {
        PathBuilder builder = new PathBuilder();
        ...
        return builder
                ...
                .setLinearHeadingInterpolation(leftmostSamplePose.getHeading(), basketPos.getHeading())
                //.strafeToLinearHeading(new Vector2d(-44, -37), Math.toRadians(152))
                .build();
    }
    ...
    public static PathChain basketToSubmersible(Drivetrain drive) {
        return drive.getBuilder()
                .addPath(new BezierCurve(
                        ...
                        new Point(57.800, 132.845, Point.CARTESIAN),
                        new Point(60.200, 96.221, Point.CARTESIAN)
                ))
                .setLinearHeadingInterpolation(basketPos.getHeading(), Math.toRadians(270))
                .build();
    }
    ...
    public static PathChain submersibleToBasket(Drivetrain drive) {
        return drive.getBuilder()
                ...
                .setLinearHeadingInterpolation(Math.toRadians(270), basketPos.getHeading())
                .build();
    }
    ...
    public static PathChain basketToSubmersible2(Drivetrain drive) {
        return drive.getBuilder()
                .addPath(new BezierCurve(
                        ...
                        new Point(64.500, 96.221, Point.CARTESIAN)
                ))
                .setLinearHeadingInterpolation(basketPos.getHeading(), Math.toRadians(270))
                .build();
    }
